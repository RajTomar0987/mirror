...
export const ServiceShowcase: React.FC<ServiceShowcaseProps> = ({ service, index }) => {
  ...
  return (
    <motion.div
      ...
      className="group relative flex flex-col justify-between p-8 md:p-12 bg-white border border-[#e5e5e5] hover:border-[#111111] transition-all duration-500 shadow-subtle hover:shadow-premium"
    >
      <div>
        {/* Top Header */}
        ...
        {/* Title */}
        <h3 className="font-serif text-3xl sm:text-4xl md:text-5xl font-light tracking-tight text-[#111111] mb-6 group-hover:text-[#111111] transition-colors">
          {service.title}
        </h3>
