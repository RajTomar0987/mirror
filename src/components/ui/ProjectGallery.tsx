        ...
        {displayImages.map((src, index) => (
          ...
          >
            <OptimizedImage
              ...
              fill
              fallbackTitle={`${title} — Installation View 0${index + 1}`}
              sizes="(max-width: 768px) 100vw, 50vw"
            />

            {/* Hover overlay icon */}
            <div className="absolute inset-0 bg-black/30 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center text-white z-10">
          ...
          >
            ...
            >
              <OptimizedImage
                ...
                alt={`${title} detail view ${selectedIndex + 1}`}
                fill
                objectFit="contain"
                fallbackTitle={`${title} — Detail View 0${selectedIndex + 1}`}
                sizes="100vw"
